...
import ShoeDataMen from './ShoeDataWomen'
...
function Women() {
    return (
        <>
            <div>
                <img src="https://www.asics.co.in/media/.renditions/wysiwyg/homepage/1920x800_shop_now__1.jpg?auto=webp&format=pjpg&quality=85"
                ></img>
            </div>
